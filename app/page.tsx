        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-14 items-center">
          <div>
            ...
            <div className="flex flex-wrap gap-5 mt-6 text-sm text-slate-500 font-medium">
              {["Made in the USA", "Free Shipping", "Vet Approved"].map(
                (t) => (
          ...
          <div className="relative">
            <div className="rounded-2xl overflow-hidden shadow-2xl shadow-sky-100">
              <Image
                src="/hero.jpg"
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center max-w-lg mx-auto mb-12">
            ...
            <p className="text-base text-slate-500">
              Limited inventory available. Ships free from the USA.
            </p>
          </div>
